          ...
          <div className="flex flex-col md:flex-row justify-center items-start md:items-center gap-12 md:gap-24">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="mt-1 text-gray-300">chincholkarsomeh0913@gmail.com</p>
              </div>
            </div>
            ...
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="mt-1 text-gray-300">+91 8767953598</p>
              </div>
            </div>
            ...
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="mt-1 text-gray-300">Pune, Maharashtra, India</p>
              </div>
            </div>
          </div>
